...
public class MainActivity extends AppCompatActivity implements
    ...
    private TextView imageInfo1, imageInfo2, imageInfo3;
    private ArrayList<MainImg> list = new ArrayList<>();
     ...
     */
    String crawlingURL ="https://www.aladin.co.kr/home/welcome.aspx";
    String main_url;
...
//        initViews();
        final EditText bookName = (EditText) findViewById(R.id.etBookName);
        btnSearchBook = (Button) findViewById(R.id.btnSearchBook);
        main_url = "http://www.kyobobook.co.kr/index.laf?OV_REFFER=https://www.google.com/";
        imageView2 = (ImageView)findViewById(R.id.imageView2);
        imageView3 = (ImageView)findViewById(R.id.imageView3);
        imageView4 = (ImageView)findViewById(R.id.imageView4);
        imageInfo1 = (TextView)findViewById(R.id.imageInfo1);
        imageInfo2 = (TextView)findViewById(R.id.imageInfo2);
        imageInfo3 = (TextView)findViewById(R.id.imageInfo3);
    ...
    private class TemiJsoup extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try{
                ...
                Elements a = doc.select("a.link_book");
                for(Element b:a) {
                    list.add(new MainImg(
                            b.select("img").attr("data-original"),
                            b.select("span.info").text()
                    ));
                }
            } catch (IOException e){
                e.printStackTrace();
        ...
        protected void onPostExecute(Void result){
            imageInfo1.setText(list.get(0).getInfo());
            imageInfo2.setText(list.get(1).getInfo());
            imageInfo3.setText(list.get(2).getInfo());
            Glide.with(getApplicationContext()).load(list.get(0).getImgUrl()).into(imageView2);
            Glide.with(getApplicationContext()).load(list.get(1).getImgUrl()).into(imageView3);
            Glide.with(getApplicationContext()).load(list.get(2).getImgUrl()).into(imageView4);
        }
    }
